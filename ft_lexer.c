...
/*   Updated: 2022/06/28 04:04:44 by nali             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	we are spliting redirections and pipes before expansion beacuse we do not
	want a shell variable to expand if it appears right after <<. To check 
	this condition we have to split before we perform expansion
	EXAMPLE: cat << "$USER"
	In this case, we should keep reading from STDIN till we enter $USER
	rather than the expansion of that variable*/
